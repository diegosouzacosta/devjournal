...
class ProjectBuilderTestCase(TestCase):
    def test_project_builder_new_project(self):
        ...
        self.assertEqual(project.name, project_json.get('login'))
        self.assertEqual(project.description, project_json.get('description'))
        self.assertEqual(project.html_url, project_json.get('url'))
        self.assertEqual(project.created_at, project_json.get('url'))
        # self.assertEqual(project.creator, project_json.get('url'))
        # self.assertEqual(project.organization, project_json.get('url'))
